    ...
    <div className='grid grid-cols-1 gap-4 mt-10'>
        {dealsbanner.map((banner) => (
            <div className='w-full relative h-100 bg-template-whitesmoke overflow-hidden group rounded-lg font-template-badoni'>
                            ...
                            <div className="absolute top-2 right-2 text-white font-medium text-2xl ">
                                50% OFF
                            </div>
                            ...
                            <div className='max-w-lg text-[20px] md:leading[48px] absolute top-55 left-5 text-white font-medium text-2xl'>{banner.subtitle}</div>
                            <button className=' flex  items-center gap-2 text-white bg-black/80 p-2 rounded-lg absolute top-75 left-5'>{banner.link}
                            <FaArrowRight />
                            </button>
                            </div>
